...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_user.setToolTip(_translate("MainWindow", "<html><head/><body><p>Username goes here.</p></body></html>"))
        self.lineEdit_user.setPlaceholderText(_translate("MainWindow", "USERNAME"))
        self.lineEdit_password.setToolTip(_translate("MainWindow", "<html><head/><body><p>Password goes here.</p></body></html>"))
        self.lineEdit_password.setPlaceholderText(_translate("MainWindow", "PASSWORD"))
        self.checkBox_save_user.setToolTip(_translate("MainWindow", "<html><head/><body><p>Use this option if u want to save the username and password for auto-login.</p></body></html>"))
        self.checkBox_save_user.setText(_translate("MainWindow", "Save User"))
        self.pushButton_login.setToolTip(_translate("MainWindow", "<html><head/><body><p>Load the program.</p></body></html>"))
        self.pushButton_login.setText(_translate("MainWindow", "Load Program"))
        self.checkBox_register_user.setToolTip(_translate("MainWindow", "<html><head/><body><p>Use this option if u don\'t have an account.</p></body></html>"))
        ...
        self.lineEdit_license.setToolTip(_translate("MainWindow", "<html><head/><body><p>Only if u want to register! Key goes here...</p></body></html>"))
